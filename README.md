...
**📌DEPLOY ON HEROKU**
   ...
   - ***`Get Session` by [`SCANING QR`](https://flash-md-qr.onrender.com) Or [`PAIRING CODE`](https:/ibrahim-tech-1-4a7321f212d3.herokuapp.com) Then `Go-to Whatapp>Three dots>Linked Devices`***
